<template>
  <div>
    ...
    <PresentationProfilPage :slice="slices[2]"></PresentationProfilPage>
    <Crsl :slice="slices[3]"></Crsl>
    <PresentationProfilPage :slice="slices[4]"></PresentationProfilPage>
    <CareerNumbersList :slice="slices[5]"></CareerNumbersList>
    <PresentationProfilPage :slice="slices[6]"></PresentationProfilPage>
    <Crsl :slice="slices[7]"></Crsl>
...
import Crsl from "~/components/Career/Profil/CrSl.vue";
import CareerNumbersList from "~/components/Career/Profil/CareerNumbersList.vue";
import PresentationProfilPage from "~/components/Career/Profil/PresentationProfilPage.vue";
...
export default {
  ...
  async asyncData({ $prismic, params, error }) {
    try {
      ...
      const result = await $prismic.api.getSingle("career", lang);
...
//   width: 42px;
//   height: 42px;
//   // background-image: url("~/assets/img/client-slider/arrow.png");
