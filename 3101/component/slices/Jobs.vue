    ...
    <div id="menu">
      <div id="menuContainer">
        <ul id="menuList">
          ...
          <li class="menuOption">
            <nuxt-link id="jobsMenu" to="jobs">Jobs</nuxt-link>
          </li>
        </ul>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    doublon(item) {
      ...
      document.querySelector(".lien").style.paddingRight = "505px";
...
#jobs
  ...
  .search-wrapper
    ...
    form
      ...
      .searchVille
        background-image: url('@/images/select Géolocalisation.png')
        background-repeat: no-repeat
